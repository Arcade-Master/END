...
if __name__ == "__main__":
    ...
    # parser.add_argument("--max_gpu_memory", type=int, default=65)
    ...
    if len(early_exit_layers) == 1:
        print("Naive decoding from the last layer", flush=True)
        mode = "baseline"
        mature_layer = None
    ...
    for sample in tqdm(list_data_dict):
        ...
        generate_kwargs = dict(max_new_tokens=args.max_new_tokens, top_p=args.top_p, top_k=args.top_k, temperature=args.temperature, repetition_penalty=args.repetition_penalty, mode=mode, mature_layer=mature_layer, premature_layer=premature_layer, candidate_premature_layers=candidate_premature_layers,en_alpha=args.alpha,relative_top=args.relative_top)
        ...
        print(f'Num of total question: {i}.')
        i = i + 1
