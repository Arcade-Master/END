...
if __name__ == "__main__":
    ...
    print(f" == {name} ==  {float(sum(answers))/len(answers)}")
    # print(f"fp:{name} , threshold {threshold} , {float(sum(answers))/len(answers)}")